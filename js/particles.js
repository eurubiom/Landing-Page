...
hamburguerIcon.addEventListener ('click', ()=>{
   ...
   navOverlay.classList.toggle('nav__overlay--show'); /*The toggle method allows each time it is executed to change the visibility of the HTML element, that is, if it is visible it becomes hidden 
   and if it is hidden it becomes visible.*/
});
